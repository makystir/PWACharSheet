  ...
  return (
    <div className={styles.sectionGap}>
      ...
      <CombatDashboard
        ...
        onUpdateAdvantage={(d) => update('advantage', d < 0 ? decrementAdvantage(character.advantage) : d === -character.advantage ? 0 : incrementAdvantage(character.advantage))}
      ...
      {inCombat && (
        <>
          ...
          <TakeDamagePanel toughnessBonus={TB} armourPoints={armourPoints} wCur={character.wCur} totalWounds={totalWounds}
            onApplyWounds={(w) => update('wCur', Math.max(0, character.wCur - w))} />
        </>
      )}
